...
![A photograph of *Isodontia mexicana* visiting flowers of *Pycnanthemum tenuifolium*. Posted to iNaturalist (https://www.inaturalist.org/observations/91809468) from its native range in North America. &copy; Louise Woodrich, used under the CC-By (http://creativecommons.org/licenses/by/4.0/) license.](./Figures/Figure1.jpeg){ width=80% }
...
### List of plant species, genera and family visited by *Isodontia mexicana*
...
![Matching plant species (a), genera (b) and families (c) from expert and app identification, with scores higher than 0.8 or 0.5, respectively.](./Figures/Figure2_sm.jpeg)
...
### Colour preferences and type of interactions recorded
The most frequently photographed flower colour associated with *I. mexicana* was white, followed by yellow, and then, significantly less frequently, purple, blue, and pink (Figure 3a). Feeding or sitting on flowers was also the most common interaction in which the wasp was observed, but resting on non-flowering plants was also frequently recorded (Figure 3b). 


![a) Colour preferences and b) type of interaction as classified from iNaturalist images by experts.](./Figures/Figure3_sm.jpeg)
