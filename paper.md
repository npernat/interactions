...
In the case of *I. mexicana*, the results of plant-pollinator interactions are largely consistent with what is already known from the literature (not exclusive) that we examined during the hackathon [@10.1002/biuz.201810645],[@2012:Ćetković],[@2015:Friebe],[@2020:Lanner],[@2005:Rennwald],[@2016:Tischendorf],[@2020:Westrich],[@10.5281/zenodo.5153230],, but other plants have been found, which *I. mexicana* feeds on or visits, such as *Smyrnium perfoliatum*. The high number of plants from the *Apiaceae* and *Asteraceae* families is also congruent with what is known about the wasp and also not surprising, as these are common plant taxa, especially in locations where citizen scientists tend to observe nature (e.g. their own gardens, parks or nature reserves). 
